...
class DiceLoss(nn.Module):
    ...
    def forward(self, preds, targets, smooth=1.48424e-07):
...
class FocalLoss(nn.Module):
    def __init__(self, alpha=1.28777, gamma=3):
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        dice_score, iou_score = check_accuracy(test_loader, model, device=DEVICE, save_folder="debug_plots/")
